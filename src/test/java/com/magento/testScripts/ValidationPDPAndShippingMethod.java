...
public class ValidationPDPAndShippingMethod extends TestBase{
...
SoftAssert sa=new SoftAssert();
	...
	public void validateShippingMethod(Hashtable<String,String> data) throws Throwable{
		...
		Map<String,String> fileUploading=excelUtility.readExcelCellValueGivenTheKey(PropertiesUtility.getPropertyValueByKey("ShippingMethodvalidationExcel"), PropertiesUtility.getPropertyValueByKey("sheetForFiles"));
