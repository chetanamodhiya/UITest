...
public class ValidateCustomerDefaultAddress1 extends TestBaseWithBefore_AfterMethod{
	...
	SoftAssert sa=new SoftAssert();
		...
		public void userList(Hashtable<String,String> data) throws Throwable{
			...
			address.validateDefaultBillingAddress(data.get("Billing_Company"),data.get("Billing_Street"),data.get("Billing_City"),data.get("Billing_Region"),data.get("Billing_Postcode"),data.get("Billing_Telephone"),sa);
		}
